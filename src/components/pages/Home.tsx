      ...
      <div>
        <header className="main-header">
          <div className="header-side flex flex-col gap-2 justify-center">
            ...
            <Link href="/projects" className="button primary-button max-w-fit mt-2">View projects</Link>
          </div>
        ...
        <div className="home-main-wrp">
          <main className="home-main flex flex-col">
            <section className="home-section" id="about">
              <h2 className="flex gap-2.5 section-heading max-w-fit">About <Link href="#about" className="section-link-self flex items-center">
            ...
            <section className="home-section" id="projects">
              ...
              <p className="home-section-text">You can find all of my projects <Link href="/projects">right here</Link>.</p>
            </section>
